...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" onclick="return confirm('delete this from cart?');">
            <img src="images/delete.png" alt="Delete Icon" class="a-times">
         </a>
         ...
         <form action="" method="post">
            ...
            <input type="submit" name="update_cart" value="update" class="btn1">
         </form>
         <div class="sub-total"> Sub total : <span><b>₱<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?></b></span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>Grand total : <span><b>₱<?php echo $grand_total; ?></b></span></p>
      <div class="flex">
