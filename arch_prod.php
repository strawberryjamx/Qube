...
if (isset($_POST['add_to_cart'])) {
   ...
   if (mysqli_num_rows($check_cart_numbers) > 0) {
      ...
      $insert_query = "INSERT INTO `cart` (user_id, name, description, price, quantity, image) VALUES ('$user_id', '$product_name', '$product_description', '$product_price', '$product_quantity', '$product_image')";
...
<body>
   ...
   <section class="products">
      ...
      <h1 class="title">Architectural 3D</h1>

      <div class="box-container">

         <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `arch_prod`") or die(mysqli_error($conn));
